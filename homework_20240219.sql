...
set new_salary = salary * (
  case
    when department = 'Sales' THEN 1.20
    when department = 'Finance' THEN 1.15
    when department = 'Shipping' THEN 1.10
    when department = 'Marketing' THEN 1.25
    when department = 'HR' THEN 1.20
    when department = 'IT' THEN 1.35
    else 1
  end
)
